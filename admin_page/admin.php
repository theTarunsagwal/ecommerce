...
<head>
    ...
    <link rel="stylesheet" href="./css_admin_page/admin.css">
...
<body>
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li><a href="admin.php" class="use">user</a></li>
    ...
    <h1 class="titel">Welcome Admin <span class="titel_admin">

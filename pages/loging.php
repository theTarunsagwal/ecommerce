...
<body>
	<div class="logo">
	<a href="index.php">
	<img src="./img/logo_black.png" alt="loading...">
	</a>
	</div>
	<div class="body">
	<div class="form-container">
      ...
      <form method="POST" class="form">
        <input type="text" name="user" class="input" placeholder="Email Or Username">
        <input  type="password" name="pswd" class="input" placeholder="Password">
        <a href="forgat.php" class="page-link">
          <span class="page-link-label">Forgot Password?</span>
        </a>
        <button name='sub' class="form-btn">Log in</button>
      </form>
	...
	c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"></path>
          ...
          <a href="google-auth.php">Log in with Google</a>
        </div>
      </div>
    </div>
	</div>
